...
// receipts, closers and cards in strings.go.
//
...
// room is the same mistake whichever member you pick, and it is the bug this
// file was rewritten to end: a group bubble used to be written in whichever
// member happened to trigger it, in front of everybody else.
//
...
// read — and calling it for a room is precisely the defect this replaced. It
// stays private to this file, and language_lint_test.go fails the build if
// anything outside this file reaches for it.

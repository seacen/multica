...
// Register subscribes to every event that ends a run, and to an agent being
// archived. Task-failed and task-cancelled keep the DingTalk conversation
// consistent with the web transcript — without them the run ends in silence

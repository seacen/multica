...
var concurrentIndexCleanups = map[string]string{
	// Trunk-only migrations. They predate MUL-6288 (which made up-direction
	// registration mandatory), so none of them was registered when it landed.
	// An unregistered concurrent build that gets interrupted leaves an INVALID
	// index behind and IF NOT EXISTS records it as success.
	"266_channel_outbound_queue_claim_idx":                      "idx_channel_outbound_queue_claim",
	"267_channel_outbound_queue_source_idx":                     "idx_channel_outbound_queue_source",
	"268_channel_outbound_queue_chat_session_idx":               "idx_channel_outbound_queue_chat_session",
	"270_chat_message_task_assistant_idx":                       "idx_chat_message_task_assistant",
	"272_channel_outbound_send_attempt_window_idx":              "idx_channel_outbound_send_attempt_window",
	"273_channel_outbound_send_attempt_chat_session_idx":        "idx_channel_outbound_send_attempt_chat_session",
	"275_wecom_install_session_due_idx":                         "idx_wecom_install_session_due",
	"276_wecom_install_session_request_idx":                     "idx_wecom_install_session_request",
	"277_wecom_install_session_agent_pending_idx":               "idx_wecom_install_session_agent_pending",
	"278_wecom_install_session_begin_rate_idx":                  "idx_wecom_install_session_begin_rate",
	"279_agent_task_queue_retry_of_idx":                         "idx_agent_task_queue_retry_of",
	"280_channel_outbound_queue_target_order_idx":               "idx_channel_outbound_queue_target_order",

...
const recordChannelOutboundDelivered = `-- name: RecordChannelOutboundDelivered :one
INSERT INTO channel_outbound_queue (
    installation_id,
    workspace_id,
    channel_type,
...
func (q *Queries) RecordChannelOutboundDelivered(ctx context.Context, arg RecordChannelOutboundDeliveredParams) (ChannelOutboundQueue, error) {
	row := q.db.QueryRow(ctx, recordChannelOutboundDelivered,
		arg.InstallationID,
		arg.WorkspaceID,
		arg.ChannelType,
		arg.SourceKind,
